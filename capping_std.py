...
- it puts a lower cap of 1e-2 on each std value
...
for ensemble_size in ensembles_list:
    for iteration_num in range(1, 11):
        ...
        loc = f"C:/Users/xious/Documents/Year 3/BSc Project/Quantifying accuracy/Leo noiseless week 4/{ensemble_size} models/{iteration_num} iterations"
